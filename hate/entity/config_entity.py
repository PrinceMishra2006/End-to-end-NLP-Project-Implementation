...
class ModelTrainerConfig:
    ...
    def __init__(self):
        ...
        self.TRAINED_MODEL_DIR: str = os.path.join(os.getcwd(),ARTIFACTS_DIR,MODEL_TRAINING_ARTIFACTS_DIR)
...
class ModelPusherConfig:
    ...
    def __init__(self):
        self.TRAINED_MODEL_PATH = os.path.join(os.getcwd(),ARTIFACTS_DIR,MODEL_TRAINING_ARTIFACTS_DIR)
        self.BUCKET_NAME = BUCKET_NAME
        self.MODEL_NAME = MODEL_NAME
